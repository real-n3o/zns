...
async function prepareUpgradeImpl(provider, manifest, proxyAddress, Contract, opts) {
    ...
    const version = upgrades_core_1.getVersion(Contract.bytecode);
    upgrades_core_1.assertUpgradeSafe(validations, version, unsafeAllowCustomTypes);
    ...
    upgrades_core_1.assertStorageUpgradeSafe(deployment.layout, layout, unsafeAllowCustomTypes);

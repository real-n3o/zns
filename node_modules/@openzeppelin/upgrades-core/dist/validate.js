...
exports.isUpgradeSafe = exports.getErrors = exports.ValidationErrors = exports.assertUpgradeSafe = exports.getStorageLayout = exports.getContractVersion = exports.validate = void 0;
...
function validate(solcOutput, decodeSrc) {
    ...
    for (const source in solcOutput.contracts) {
        for (const contractName in solcOutput.contracts[source]) {
            ...
            const version = bytecode === '' ? undefined : version_1.getVersion(bytecode);
...
function assertUpgradeSafe(validation, version, unsafeAllowCustomTypes = false) {
    const contractName = getContractName(validation, version);
